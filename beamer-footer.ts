...
<\body>
  ...
  <assign|bar-border-color|#307fcc> --- Color of the border for the title and
  footer bars
  ...
  <drd-props|bar-border-color|macro-parameter|color>
  ...
  <assign|cover-title|<\macro|body>
    <\with|ornament-shape|classic|ornament-color|<value|title-bar-color>|ornament-sunny-color|<value|bar-border-color>|ornament-vpadding|1.7bls|ornament-shadow-color|<value|bar-border-color>>
      <\ornamented>
  ...
  <assign|cover-footer|<\macro|left|right>
    <\with|ornament-shape|classic|ornament-color|<value|footer-bar-color>|ornament-sunny-color|<value|bar-border-color>|ornament-shadow-color|<value|bar-border-color>>
      <\ornamented>
  ...
  <assign|cover|<\macro|title|author|sub-left|sub-right>
    <\with|par-par-sep|0fn|par-sep|0fn|par-ver-sep|0fn|par-line-sep|0fn>
      <with|color|<value|bar-border-color>|<resize|<tabular*|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<cwith|1|1|1|-1|cell-background|<value|title-bar-color>>|<twith|table-valign|T>|<twith|table-vmode|auto>|<cwith|1|1|1|1|cell-bborder|5px>|<cwith|1|1|1|1|cell-vmode|exact>|<cwith|1|1|1|1|cell-valign|c>|<cwith|1|1|1|1|cell-halign|c>|<cwith|1|1|1|1|cell-lsep|0.4em>|<cwith|1|1|1|1|cell-rsep|0.4em>|<cwith|1|1|1|1|cell-bsep|0.4em>|<cwith|1|1|1|1|cell-tsep|0.4em>|<cwith|1|1|1|1|cell-hyphen|t>|<table|<row|<\cell>
        <with|color|<value|title-color>|math-color|<value|title-color>|font-series|bold|font-size|1.5|<htab|5mm><arg|title><htab|5mm>>
      </cell>>>>>||0em||>>

      <shift|<with|color|<value|bar-border-color>|<tabular*|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<cwith|1|1|1|-1|cell-background|<value|footer-bar-color>>|<cwith|1|1|1|1|cell-halign|c>|<cwith|1|1|1|1|cell-hyphen|t>|<twith|table-valign|b>|<twith|table-height|0.02pag>|<twith|table-vmode|exact>|<cwith|1|1|1|1|cell-tsep|0em>|<cwith|1|1|1|1|cell-bsep|0em>|<cwith|1|1|1|1|cell-tborder|5px>|<table|<row|<\cell>
        <with|color|<value|footer-color>|math-color|<value|footer-color>|font-size|0.59|<arg|sub-left><htab|5mm><arg|sub-right>>
  ...
  <assign|ftr|<macro|left|center|right|<with|color|<value|bar-border-color>|<tabular*|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<cwith|1|1|1|-1|cell-background|<value|footer-bar-color>>|<cwith|1|1|1|1|cell-halign|c>|<cwith|1|1|1|1|cell-tsep|0ex>|<style-with|src-compact|all|<cwith|1|1|1|1|cell-bsep|0em>>|<cwith|1|1|1|1|cell-tborder|<value|ftr-border-height>>|<cwith|1|1|1|1|cell-vmode|auto>|<twith|table-height|0.03pag>|<twith|table-vmode|exact>|<cwith|1|1|1|1|cell-hyphen|t>|<twith|table-lsep|0>|<twith|table-rsep|0>|<twith|table-bsep|0>|<twith|table-tsep|0>|<twith|table-bborder|0>|<cwith|1|1|1|1|cell-valign|c>|<twith|table-valign|f>|<table|<row|<\cell>
  ...
  <assign|hdr|<macro|left|center|right|<with|color|<value|bar-border-color>|<resize|<tabular*|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<cwith|1|1|1|-1|cell-background|<value|title-bar-color>>|<cwith|1|1|1|1|cell-halign|c>|<cwith|1|1|1|1|cell-hyphen|t>|<twith|table-valign|T>|<twith|table-vmode|auto>|<cwith|1|1|1|1|cell-height|0.05pag>|<cwith|1|1|1|1|cell-vmode|exact>|<cwith|1|1|1|1|cell-bborder|<value|tit-border-height>>|<table|<row|<\cell>
    <with|color|<value|title-color>|math-color|<value|title-color>|font-series|bold|<arg|left><htab|5mm><arg|center><htab|5mm><arg|right>>
  </cell>>>>>||0em||>>>>

  \;

  --- The macro constructing the top and bottom bars. Note that the top right
  content (the page counter) is disabled within a phantom. Instead it is
  placed in the footer

  <assign|tit|<\macro|head|foot-left|foot-center>
    <\with|par-left|<minus|<value|page-screen-left>>|par-right|<minus|<value|page-screen-right>>|par-par-sep|0fn|par-sep|0fn|par-ver-sep|0fn|par-line-sep|0fn>
      <\reduce-by>
        <shift|<hdr|<title-left|<arg|head>>|<arg|head>|<phantom|<title-right|xxx>>>|0mm|<value|page-screen-top>>

        <shift|<ftr|<arg|foot-left>|<arg|foot-center>|<title-right|xxx>>|0mm|<minus|0.959pag>>
      <|reduce-by>
        1ex
      </reduce-by>
    </with>
  ...
  <assign|btit|<\macro|left|center>
    <\with|par-left|<minus|<value|page-screen-left>>|par-right|<minus|<value|page-screen-right>>|par-par-sep|0fn|par-sep|0fn|par-ver-sep|0fn|par-line-sep|0fn|par-hor-sep|0fn|par-mode|left>
      <reduce-by|<shift|<ftr|<arg|left>|<arg|center>|<title-right|xxx>>|0mm|<minus|0.994pag>>|1ex>
    </with>
  </macro>>
